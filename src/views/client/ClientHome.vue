  ...
  floorList.value = [
    {
      ...
      products: [
        ...
        createProduct(103, 'ThinkBook 14+ 2024款', 5299, '爆款', 'https://p2.lefile.cn/product/adminweb/2024/01/25/68783451-2475-4375-8656-547348325656.jpg'),
    ...
    },
    {
      ...
      products: [
        createProduct(601, 'YOGA Air 14s 2024', 8999, '超轻薄', 'https://p1.lefile.cn/product/adminweb/2023/08/15/1692088765432.jpg'),
        createProduct(602, 'YOGA Pro 14s', 7999, '至尊版', 'https://p2.lefile.cn/product/adminweb/2023/06/20/1687255667788.jpg'),
        createProduct(603, 'YOGA 27 一体机', 9999, '4K全面屏', 'https://p3.lefile.cn/product/adminweb/2023/10/10/1696922334455.jpg'),
        createProduct(604, 'YOGA 鼠标', 199, '时尚', 'https://p4.lefile.cn/product/adminweb/2022/03/15/1647333445566.jpg')
      ]
    },
    {
      id: 'legion',
    ...
    },
    {
      ...
      products: [
        createProduct(501, 'ThinkBook 14+ 2024', 5499, '全能本', 'https://p1.lefile.cn/product/adminweb/2024/01/28/1706433445566.jpg'),
        createProduct(502, 'ThinkBook 16+ 2024', 5799, '大屏商务', 'https://p2.lefile.cn/product/adminweb/2024/02/05/1707122334455.jpg'),
        createProduct(503, 'ThinkBook Plus Twist', 8999, '旋转双屏', 'https://p3.lefile.cn/product/adminweb/2023/06/15/1686811223344.jpg'),
        createProduct(504, 'ThinkBook 背包', 199, '通勤', 'https://p4.lefile.cn/product/adminweb/2022/09/20/1663655443322.jpg')
      ]
    }
  ]
}
...
.category-list { 
  list-style: none; padding: 0; margin: 0; height: 100%; display: flex; flex-direction: column; 
}

/* flex: 1 让每个菜单项平分高度 */
.category-item { 
  flex: 1; display: flex; align-items: center; justify-content: space-between; padding: 0 40px; 
  cursor: pointer; transition: all 0.3s; border-bottom: 1px solid rgba(0,0,0,0.03); 
}
.category-item:last-child { border-bottom: none; }
.category-item:hover { background-color: #fff; color: var(--el-color-primary); box-shadow: 4px 0 10px rgba(0,0,0,0.1); z-index: 1; }
.cat-name { font-size: 18px; font-weight: 700; color: #333; letter-spacing: 1px; }
...
:deep(.el-carousel__indicator--horizontal.is-active .el-carousel__button) { width: 25px; height: 10px; border-radius: 5px; background-color: #ffffff; opacity: 1; }
